...
<html lang="fr">
    ...
    <link href=".\register\css\offer.css" rel="stylesheet">
    </head>
    <body>
                <!-- Loader -->
    <!-- <div id="preloader">
    ...
    <header id="topnav" class="defaultscroll sticky">
        <div class="container">
            ...
            <div>
                <a class="logo" href="/">
                    <img src="images/logo-dark.png" height="60" alt="">
                </a>
            </div>
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href=".\redis.html">Redis</a> <a href=".\mysql.html">Mysql</a></li>
                        </ul>
                    </li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 col-md-7">
                    <div class="title-heading mt-4">
                        <h1 class="heading mb-3">Stocker <span class="text-primary">plus</span>, et plus <span class="text-primary">rapidement</span>. Avec du Mysql.</h1>
                        <p class="para-desc text-muted">Pour cela il existe speedheberg un hébergeur de base de donné Français.</p>
                        <div class="mt-4">
                            <a href="#generic_price_table" class="btn btn-primary mt-2 mr-2"><i class="mdi mdi-email"></i> Offre.</a>
                        </div>
                    </div>
                </div><!--end col-->

                <div class="col-lg-5 col-md-5 mt-4 pt-2 mt-sm-0 pt-sm-0">
                    <img style="width: 600px;" src=".\images\illustrator\sc2.webp" alt="">
                </div><!--end col-->
            </div><!--end row-->
        </div><!--end container-->
    </section><!--end section-->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="generic_content clearfix">
                                ...
                                <div class="generic_feature_list">
                                    <ul>
                                        <li><span>80 GB</span> Stockage</li>
                                        <li><span>250 Mbit/s</span> Connection</li>
                                        <li><span>6 Go</span> Mémoire</li>
                                        <li><span>1</span> Node dédié</li>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="generic_content active clearfix">
                                ...
                                <div class="generic_feature_list">
                                    <ul>
                                        <li><span>200 GB</span> Stockage</li>
                                        <li><span>500 Mbit/s</span> Connection</li>
                                        <li><span>6 Go</span> Mémoire</li>
                                        <li><span>2</span> Node dédié</li>
                                        <li><span>24/7</span> Support</li>
                                    </ul>
                                </div>
                                <!--//FEATURE LIST END-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="generic_content clearfix">
                                ...
                                <div class="generic_feature_list">
                                    <ul>
                                        <li><span>1 To</span> Stockage</li>
                                        <li><span>1 Gbit/s</span> Connection</li>
                                        <li><span>8 Go</span> Mémoire</li>
                                        <li><span>4</span> Node dédié</li>
                                        <li><span>24/7</span> Support</li>
                                    </ul>
                                </div>
                                <!--//FEATURE LIST END-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                    ...
                    <p class="mt-4">Oqoo, simplify everything.<br></p>
                </div><!--end col-->

                <div class="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <h4 class="text-light footer-head">Informations</h4>
                    <ul class="list-unstyled footer-list mt-4">
                        <li><a href="/legal" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i>CGU</a></li>
                    </ul>
                </div><!--end col-->

                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <h4 class="text-light footer-head">Utilities</h4>
                    <ul class="list-unstyled footer-list mt-4">
                        <li><a href=".\register\register.html" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Sign up</a></li>
                        <li><a href=".\login\login.html" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Log in</a></li>
                    </ul>
                </div><!--end col-->

                <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <h4 class="text-light footer-head">Newsletter</h4>
                    <p class="mt-4">Sign up and receive our newsletters.</p>
                    <form>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="foot-subscribe form-group position-relative">
                                    <label>Provide your email <span class="text-danger">*</span></label>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="text-sm-left">
                        <p class="mb-0">© 2022 Oqoo Agency - All rights reserved.</p>
                    </div>
                </div><!--end col-->
